...
- تصويت مفتوح لأي زائر بدون تسجيل دخول، **بصوت واحد من كل جهاز** (كوكي موقَّع + سجل في قاعدة البيانات)، وعدد الأصوات ظاهر للجميع تحت كل صورة (يتحدث تلقائياً كل 20 ثانية)
