...
- تصويت مفتوح لأي زائر بدون تسجيل دخول، **بصوت واحد لكل صورة من كل جهاز** (كوكي + سجل في قاعدة البيانات)، وعدد الأصوات ظاهر للجميع تحت كل صورة (يتحدث تلقائياً كل 20 ثانية)
